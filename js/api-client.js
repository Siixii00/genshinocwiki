...
if (typeof window !== 'undefined') {
    ...
    formatCharacter(char) {
        return {
            ...
            skillBurstName: char.skills?.burst?.name || char.skillBurstName || null,
            skillBurstDesc: char.skills?.burst?.desc || char.skillBurstDesc || null,
            constellations: JSON.stringify(char.constellations || []),
            customImages: JSON.stringify(char.customImages || []),
            normalVoices: JSON.stringify(char.voices?.normal || char.normalVoices || []),
            combatVoices: JSON.stringify(char.voices?.combat || char.combatVoices || []),
            modelType: char.model?.type || char.modelType || null,
            modelUrl: char.model?.url || char.modelUrl || null
        };
    },
